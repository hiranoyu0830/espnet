    ...
    for key in data[0]:
        ...
        if key == "spk_labels":
            ...
            for d_spk in data:
                ...
                assert num_speakers <= 10, f"too large num_speakers: {num_speakers} > 10"
        ...
        # this operation is also applied to the 'num_spk' key
